...
Revision ID: 850be3896d6e
Revises: 
Create Date: 2025-01-14 23:06:39.835776
...
def downgrade():
    ...
    sa.PrimaryKeyConstraint('diagram_id', name='PK__sysdiagr__C2B05B61E0198AE3')
    )
